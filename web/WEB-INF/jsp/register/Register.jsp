...
<main class="form-signin">
    ...
    <c:if test="${requestScope.img == null}">
        <form action="${ctx}/updateImg" method="post" enctype="multipart/form-data">
            ...
            <input type="submit" class="btn btn-primary" value="上传头像"/>
        </form>
    </c:if>
    <form action="${ctx}/register_user" method="post">
        ...
        <div class="form-floating">
            <input type="text" class="form-control" id="floatingInput" name="accement_name" placeholder="请输入你的账号">
            <label for="floatingInput">accementName</label>
        </div>
        <div class="form-floating">
            <input type="password" class="form-control" id="floatingPassword" name="password" placeholder="请输出你的密码">
